...
ASM_CMD(kMore,        more_op_count,          "jb",  "more_op_end")
ASM_CMD(kLessOrEqual, less_or_euqal_op_count, "ja",  "less_or_equal_op_end")
ASM_CMD(kMoreOrEqual, more_or_equal_op_count, "jbe", "more_or_equal_op_end")
